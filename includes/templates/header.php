...
<body>
        ...
        <div class="Redes_princ">
            <li class="Redes">
                <a href="https://www.instagram.com/vive_composta/?hl=es-la" target="_blank">
                    <img src="/vectores/Logos_redes_inicio/insta cafe.png" alt="Instagram">
                </a>
                <a href="https://www.facebook.com/Vivecomposta" target="_blank">
                    <img src="/vectores/Logos_redes_inicio/face cafe.png" alt="Facebook">
                </a>
                <a href="https://www.tiktok.com/@vive_composta" target="_blank">
                    <img src="/vectores/Logos_redes_inicio/tiktok cafe.png" alt="TikTok">
                </a>
            </li>
            <h1>Generando gramos de vida</h1>
            <div class="InicioS">
                <a href="/login.php">
                    <img src="/vectores/IniciarSesion/ICONO INICIO SESIÓN HORIZONTAL CAFE.svg" alt="" class="IconoInicioCafe">
    ...
    <nav class="NavMobile">
        ...
        <a href="/login.php" class="IconoIniciarS">
            <img src="/vectores/IniciarSesion/ICONO INICIO SESIÓN VERTICAL NARANJA.svg" alt="" class="IconoInicioNaranja">
        </a>
