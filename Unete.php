...
<main class="PrimerVista SectionUnete">
    <section class="UnetePasos">
        <div class="ContendorPasos">            
            <div class="Texto">
    ...
    <section class="SeParteYFamilias">
        ...
        <figure class="Familias">
            <img src="build_previo/img/Unete/IMAGEN FAMILIAS.webp" alt="" class="Famliasimg">
            <h3>+<span>0</span></h3>
            <h5>FAMILIAS INSCRITAS</h5>
        </figure>
    </section>
